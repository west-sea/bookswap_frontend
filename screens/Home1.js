...
const Home1 = () => {
  const [notificationsUnreadIconVisible, setNotificationsUnreadIconVisible] =
    useState(false);

  const openNotificationsUnreadIcon = useCallback(() => {
    setNotificationsUnreadIconVisible(true);
  }, []);

  const closeNotificationsUnreadIcon = useCallback(() => {
    setNotificationsUnreadIconVisible(false);
  }, []);
  ...
  return (
    <>
      <View style={styles.home}>
        ...
        <View style={[styles.frameContainer, styles.framePosition]}>
          ...
          <View style={[styles.rectangleGroup, styles.rectangleLayout]}>
            ...
            <View style={styles.frameParent1}>
              ...
              <View
                style={[styles.reservatedWrapper, styles.wrapperSpaceBlock]}
              >
        ...
        />
        <Pressable
          style={[styles.notificationsUnread, styles.searchIconLayout]}
          onPress={openNotificationsUnreadIcon}
        >
          <Image
            style={styles.icon}
            resizeMode="cover"
            source={require("../assets/notifications-unread1.png")}
          />
        </Pressable>
      </View>
      ...
      <Modal
        animationType="fade"
        transparent
        visible={notificationsUnreadIconVisible}
      >
        <View style={styles.notificationsUnreadIconOverlay}>
          <Pressable
            style={styles.notificationsUnreadIconBg}
            onPress={closeNotificationsUnreadIcon}
          />
          <Notification1 onClose={closeNotificationsUnreadIcon} />
        </View>
      </Modal>
    </>
  );
...
const styles = StyleSheet.create({
  ...
  notificationsUnreadIconOverlay: {
    flex: 1,
    alignItems: "center",
    justifyContent: "center",
    backgroundColor: "rgba(113, 113, 113, 0.3)",
  },
  notificationsUnreadIconBg: {
    position: "absolute",
    width: "100%",
    height: "100%",
    left: 0,
